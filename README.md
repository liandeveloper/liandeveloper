# 💫 About Me:
Hi, my dev´s name is ``Lian``, I´m a ``Web Developer`` and a future ``Data Science``, specialized in landing pages, digital business cards. Now I´m working in my `Open Source` project.
